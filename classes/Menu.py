...
class Menu:
    ...
    def drawMenu(self):
        self.drawDot()
        self.dashboard.drawText("SLOW LICK", 180, 280, 24)
        self.dashboard.drawText("HRRRR", 180, 320, 24)
        self.dashboard.drawText("GO TO CRATE", 180, 360, 24)
    ...
    def drawSettings(self):
        ...
        self.dashboard.drawText("MAKER MODE", 500, 350, 14)
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_ESCAPE:
                    ...
                    if self.inSettings:
                        ...
                        self.level.loadLevel("Level0-0")
                        self.dashboard.levelName = "MAKER"
                        self.start = True
